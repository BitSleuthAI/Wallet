...
- **Documentation organization**: 
  ...
  - Root-level exceptions: `README.md`, `CONTRIBUTING.md`, `LICENSE.md`, `CHANGELOG.md`, `AGENTS.md`, and `.github/copilot-instructions.md`
  - Docs folder includes: product requirements, implementation summaries, testing guides, design documents, API documentation, architecture documentation, deployment guides, troubleshooting guides, and TODO lists
